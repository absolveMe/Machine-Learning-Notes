...
→ Viết chi tiết và demo thực hành đi kèm(chưa có)
...
- tìm hiểu thêm về unsupervised trên trang machinelearning cơ bản.(chưa có)
...
2.Cập nhật momen bậc 1: (tính đà di chuyển từ quá khứ)
