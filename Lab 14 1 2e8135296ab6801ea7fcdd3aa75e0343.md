...
- Việc tiền xử lý này bao gồm:
    ...
    - Xử lý các giá trị ngoại lệ:
        ...
        ![image.png](Lab%2014%201/image.png)
...
![image.png](Lab%2014%201/image%201.png)
...
- Ngoài 2 cách trong Data Normalization mình có:
    ...
    ![image.png](Lab%2014%201/image%202.png)
    ...
    ![image.png](Lab%2014%201/image%203.png)
...
- SGD
    ...
    ![stochastic.webp](Lab%2014%201/stochastic.webp)
    ...
    ![image.png](Lab%2014%201/image%204.png)
...
- Mình làm như này là do trong bước 5, nếu vt lớn thì thuật toán sẽ chia nhỏ bước đi đi
    ...
    - Epsilon là một số cực kỳ nhỏ (10^-8) thường để tránh đi việc chia cho 0)
        ...
        ![image.png](Lab%2014%201/image%205.png)
...
- Preprocessing
    ...
    Được viết ở [trên](Lab%2014%201%202e8135296ab6801ea7fcdd3aa75e0343.md)
